...
<title>后台管理系统</title>
<link rel="stylesheet" href="/Roads/Public/Admin/css/css.css">
<script src="/Roads/Public/Admin/js/jquery-1.9.1.js"></script>
<script src="/Roads/Public/Common/Layer-1.9.3/layer.js"></script>
<script>
$(function(){
...
<div class="nav">
	<div class="nav_title">
    	<h2><img class="nav_img" src="/Roads/Public/Admin/img/tab.gif"><a class="nav_a" href="#">添加用户组</a></h2>
    </div>
    <div class="nav_button">
    	<a href="javascript:history.go(-1);"><button class="button">返回上一层</button></a>
    </div>
</div>
<form name="myform" action="/Admin/Admin/group_add.html" method="post" onsubmit="return check_form();">
<div class="list">
